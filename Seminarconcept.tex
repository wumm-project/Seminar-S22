...
\bibitem{Bindel} Michelle Bindel (2022).  \emph{System Model Innovation with
  Business TRIZ}.  Seminar Paper.
  \url{https://github.com/wumm-project/Seminar-W21/blob/master/SeminarPapers/MichelleBindel.pdf}
\bibitem{HSI} Darrell Mann (2007). \emph{Hands-On Systematic Innovation for
  Business and Management}.  IFR Press. 
\bibitem{Mintzberg} Henry Mintzberg (1989).  \emph{Mintzberg on Management}.
\bibitem{Sommerville} Ian Sommerville (2007).  \emph{Software Engineering}.
