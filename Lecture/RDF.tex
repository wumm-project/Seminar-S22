...
\begin{frame}{RDF Basics. Example}
  ...
  {\small\tt \begin{tabbing}\hskip2em\=\kill
    @prefix lv: {\lt}http://od.fmi.uni-leipzig.de/lv/{\gt} .\\
...
More example in the WUMM RDF Database:
\url{https://github.com/wumm-project/RDFData}

See also \url{http://wumm.uni-leipzig.de/}\vskip1em
\end{frame}
